import { isRecipeAllowedForProfiles, passesRepetitionRules } from './filters';
 ...
 * rules, score the survivors, then weighted-random pick among the top N.
 * Returns null when nothing passes the hard filters (caller decides the
 * fallback – e.g. leave the slot empty for manual assignment).
 */
